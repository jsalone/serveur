...
def addPlayer():
	...
	print"-------------------",limonda
	racord =db.select ("INSERT INTO avoir(idRecette,idJoueur,vendre,RecettePrix) VALUES (%(rec)s,%(idjou)s,%(vend)s,%(rec)s) RETURNING idRecette", {"rec" : limonda['idrecette'],"idjou" : result[0]['idjoueur'], "vend" : 0, "rec" : 0.0 })
